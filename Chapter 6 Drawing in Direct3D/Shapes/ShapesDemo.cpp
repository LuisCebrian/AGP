...
void ShapesApp::BuildGeometryBuffers()
{
	...
	vertices[0].Pos = XMFLOAT3(-2.5, -2.5, 3);
	vertices[1].Pos = XMFLOAT3(-2.5, 2.5, 3);
	vertices[2].Pos = XMFLOAT3(2.5, 2.5, 3);
	vertices[3].Pos = XMFLOAT3(2.5, -2.5, 3);
...
void ShapesApp::BuildFX()
{
	...
	mGlobalTime = mFX->GetVariableByName("iGlobalTime")->AsScalar();
}
